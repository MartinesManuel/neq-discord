...
export default function CedulaPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        if (cedula.length >= 8 && nombre.trim() !== '') {
                ...
                <Card className="bg-white/90 backdrop-blur-sm">
                    <CardHeader className="space-y-2">
                        ...
                        <p className="text-center text-gray-600">
                            Para saber si calificas para un crédito de libre inversión, necesitamos verificar tu identidad y consultar tu puntaje.
                        </p>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <div className="mt-4">
                                        <Label htmlFor="nombre" className="text-gray-700 mb-3 block">Nombre y apellido</Label>
                                        <Input
                                            id="nombre"
                                            type="text"
                                            required
                                ...
                                <div className="bg-blue-50 p-4 rounded-lg space-y-2">
                                    <h3 className="font-medium text-blue-800">¿Por qué necesitamos estos datos ?</h3>
                                    <ul className="text-sm text-blue-700 space-y-1 list-disc pl-4">
                                        <li>Para validar tu identidad y consultar tu puntaje crediticio</li>
                                        <li>Para saber si calificas para un crédito de libre inversión</li>
                            ...
                            <Button
                                ...
                                disabled={cedula.length < 8 || nombre.trim() === ''}
                            >
                                Continuar
                            </Button>
